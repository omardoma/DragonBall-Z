...
public class Player implements Serializable
{
	...
	public void assignAttack(PlayableFighter fighter, SuperAttack newAttack, SuperAttack oldAttack)
			throws MaximumAttacksLearnedException, DuplicateAttackException, NotASaiyanException
	{
			...
			throws MaximumAttacksLearnedException, DuplicateAttackException, NotASaiyanException
	{
		...
		{
			if (!(fighter instanceof Saiyan) && newAttack instanceof SuperSaiyan)
